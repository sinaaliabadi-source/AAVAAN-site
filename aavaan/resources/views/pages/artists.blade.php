...
<section class="artists-hero">
    <div class="container">
        ...
        <p>رزومه، نمونه‌کار و ویدیوی هنری خودت را در آوان قرار بده تا تیم‌های تولید در سراسر کشور بتوانند تو را برای پروژه‌ی بعدی‌شان انتخاب کنند.</p>
    ...
    <div class="container">
        ...
        <div class="grid-3">
            ...
            <div class="benefit-card">
                <span class="icon">🔍</span>
                <h3>دیده‌شدن</h3>
                <p>تیم‌های تولید فعال در سراسر کشور پروفایل تو را می‌بینند</p>
            </div>
        </div>
    </div>
</section>
