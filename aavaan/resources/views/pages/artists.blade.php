    ...
    <div class="container">
        ...
        <div class="faq-list">
            ...
            <details>
                ...
                <div class="faq-body">
                    می‌توانید تصاویر نمونه‌کار (JPG، PNG)، فیلم‌های کوتاه برای ریل (MP4 حداکثر ۵۰ مگابایت) و فایل‌های صوتی (MP3) آپلود کنید. ویدیوها را همچنین می‌توانید از طریق لینک یوتیوب یا آپارات اضافه کنید.
                </div>
            </details>
            <details>
